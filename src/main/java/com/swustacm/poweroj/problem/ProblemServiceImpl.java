...
import com.swustacm.poweroj.problem.mapper.ProblemMapper;
...
public class ProblemServiceImpl extends ServiceImpl<ProblemMapper, Problem> implements ProblemService {
    ...
    @Override
    public Page<Problem> searchProblem(ProblemSearchParam params, Integer status) {
        return problemMapper.searchAll(
                new Page<Problem>(params.getPage(), params.getLimit()),
                params.getPid(), params.getSource(), params.getTitle(), status);
    }
